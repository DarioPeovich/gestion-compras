...
import SESTable from "../ui/data/SESTable";
    ...
    >
      ...
      >
        ...
        {(tipoId || tiposFiltrados.length === 1) && (
          <SESFormRow>
            <SESField label="Proveedor" required className="col-span-12">
              <SESSelect
                value={proveedorId}
          ...
          <>
            ...
            {modoIngreso === "detallado" && (
              <>
                ...
                {items.length > 0 && (
                  <SESTable className="mt-3">
                    <thead className="bg-gray-50 border-b border-gray-200">
                      <tr>
                        <th className="px-3 py-2 text-left   text-gray-600 font-medium">
                          Artículo
                        </th>
                        <th className="px-3 py-2 text-center text-gray-600 font-medium w-28">
                          Cant.
                        </th>
                        ...
                        <th className="px-3 py-2 text-center text-gray-600 font-medium w-36">
                          Tipo IVA
                        </th>
                        <th className="px-3 py-2 text-right  text-gray-600 font-medium w-28">
                          IVA
                        ...
                        <th className="px-3 py-2 text-right  text-gray-600 font-medium w-32">
                          Importe
                        </th>
                    ...
                    <tbody className="divide-y divide-gray-100">
                      {items.map((item, idx) => {
                        ...
                        return (
                          <tr
                            key={item._uid}
                            className={`hover:bg-gray-50 ${esManual ? "bg-amber-50" : ""}`}
                          >
                            {/* Artículo */}
                            ...
                            {mostrarICL && (
                              <td className="px-3 py-2">
                                {esManual ? (
                                  <span className="text-gray-300 text-xs flex justify-center">
                                    —
                                  </span>
                                ) : (
                                  <NumInput

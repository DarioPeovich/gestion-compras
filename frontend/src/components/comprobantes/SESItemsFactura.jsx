...
export default function SESItemsFactura({
  ...
  const columnasItems = [
    ...
    mostrarICL && "14ch", mostrarIDC && "14ch", mostrarImpInt && "14ch",
    "8ch", "16ch", "minmax(0, 1fr)", "1.5rem",
  ].filter(Boolean).join(" ");
        ...
        {modoIngreso === "detallado" && (
          <>
            ...
            <SESToolbar className="pt-3 pb-2">
              <SESButton variant="secondary" size="sm" onClick={agregarConceptoManual}>
                      ...
                      >
                        ...
                        >
                          ...
                          <div>
                            ...
                            >
                              {tiposIva.map((t) => <option key={t.ivaTiposID} value={String(t.ivaTiposID)}>{t.descripcion}</option>)}
                            </select>
                          </div>
                          <div>
                            <div className="mb-1 text-xs text-gray-500 text-right">IVA</div>
                            <div className="py-1 text-sm text-right text-gray-700">$ {fmt3(item.importe_iva)}</div>
                          </div>
                          {mostrarICL && (
                            <div>
                          ...
                          <div>
                            ...
                            <div className="py-1 text-sm text-right text-gray-700 font-medium">$ {fmt3(item.importe_linea)}</div>
                          </div>
